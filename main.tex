...
\begin{document}
    ...
    \begin{minipage}[t]{\textwidth}
        ...
        \begin{minipage}[t]{\cvLeftWidth}
            ...
            \cvItem{Février 2019 - Juillet 2019 (6 mois)}{Optimisation robuste (Stagiaire)}{INRIA - RealOpt}{Bordeaux}{
                \begin{itemize}
                    \item Problème d'ordonnancement avec recours
                    \item $1|r_j|\sum w_jU_j$ robuste
                    \item Programmation dynamique
                \end{itemize}
                \textit{Dantzig-Wolfe reformulation, MILP, C++}
            }
            \cvItem{Septembre 2018 - Aout 2018 (12 mois)}{Développeur backend sous Amazon Web Services}{Wide Asset Management}{Paris}{
                \begin{itemize}
